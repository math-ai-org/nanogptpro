...
CONFIG = ArithmeticsTrainConfig(
    ...
    # Optimizer configs
    optimizer_name="mucon",
    learning_rate_base=1e-4,
    min_lr_base=5e-6,
    weight_decay=0.1,
    beta1=0.9,
    beta2=0.95,
    mucon_clip_threshold=2.0,
    mucon_clip_method="rational_newton",
    mucon_approx_steps=6,
    mucon_approx_regularization=1e-6,
    grad_clip=1.0,
    decay_lr=True,
    warmup_iters=200,
    schedule="cosine",
