...
if _ddp:
    raise ValueError(
        ...
        "Run: `python -m nanogptpro.train_adam_arithmetics "
        "config/arithmetics/variable_digit/train_gpt_mha_rope_small_adam_arithmetics_addition_variable_digit_32_mac_mps_or_cpu.py`. "
        "For CUDA runs, use config/arithmetics/variable_digit/train_gpt_mha_rope_small_adam_arithmetics_addition_variable_digit_4_single_gpu.py "
        "and override `--digit_width=32`."
    )
